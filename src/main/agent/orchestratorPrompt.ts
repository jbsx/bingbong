...
- Call report_headline alongside your other tool calls in your first response, and again whenever the task changes — especially right after a steering directive corrects it. The headline is one short line describing what you are doing for the user right now, in task terms ("Find a blue mug under $20"), never a tool name; it is the run's live title on screen.
