...
// speak. A session_ended must match the Session that just ended, and
// everything else — Run output, subagent cards and announcements, detail
// signals, lifecycle starts — must carry the live Session's identity. Late
// asynchronous work from an ended or foreign Session is rejected here,
