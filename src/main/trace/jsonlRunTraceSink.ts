import type { RunTraceRecord, RunTraceSink } from '../../core/trace/runTrace'
...
export function createJsonlRunTraceSink(logsDir: string, options: JsonlSinkOptions = {}): RunTraceSink {
  return createJsonlSink<RunTraceRecord>(logsDir, { prefix: 'trace', pattern: TRACE_FILE_PATTERN }, options)
}
